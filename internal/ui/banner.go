...
ASCII art banner renderer for the vulnforge CLI header

Renders the VulnForge logo in alternating red and blue before every command.
...
func PrintBanner() {
	fmt.Println()
	fmt.Println()
	for i, line := range vulnforgeBanner {
